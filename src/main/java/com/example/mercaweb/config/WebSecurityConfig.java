package com.example.mercaweb.config;


import com.example.mercaweb.exception.AccessDeniedHandlerException;
import com.example.mercaweb.security.JwtAuthFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.exceptionHandling().accessDeniedHandler(accessDeniedHandlerException)
                .and()
                        ...
                        requests
                             ...
                             //   .requestMatchers(HttpMethod.DELETE, "/customers/**").hasRole(Roles.Admin)
                              ...
                              //  .requestMatchers(HttpMethod.GET,"/cars/**").hasAnyRole(Roles.Customer, Roles.Admin)
                                .requestMatchers(HttpMethod.GET, "/admin").hasRole(Roles.Admin)
                                .requestMatchers(HttpMethod.GET, "/mercado").hasRole(Roles.Customer)
