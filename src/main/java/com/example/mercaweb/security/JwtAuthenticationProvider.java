...
public class JwtAuthenticationProvider {
     ...
     */
    private HashMap<String, AdminDteo> listToken = new HashMap<>();
     ...
     * @return Jwt creado
     */
    public String createToken(AdminDteo adminJwt) {
        ...
        String tokenCreated = JWT.create()
                .withClaim("id", adminJwt.getId())
                .withClaim("nombres", adminJwt.getNombres())
                .withClaim("email", adminJwt.getEmail())
                .withClaim("rol", adminJwt.getRol())
                .withIssuedAt(now)
                .withExpiresAt(validity)
                .sign(algorithm);

        listToken.put(tokenCreated, adminJwt);
        return tokenCreated;
    }
    ...
    public Authentication validateToken(String token) throws AuthenticationException {
        ...
        AdminDteo exists = listToken.get(token);
        if (exists == null) {
